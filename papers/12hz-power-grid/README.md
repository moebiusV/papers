...
**supply-chain chokehold** (this whitepaper) and the **single-point-of-failure susceptibility
to physical attack on transformer assets** (forthcoming companion paper on distributed grid
resilience). Together they describe a path to electrical infrastructure that is fast to
deploy, resilient to attack, free from international supply-chain dependency, and
manufacturable in any country with industrial capacity.
